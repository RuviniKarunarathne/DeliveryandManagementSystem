...
%>
	...
	<form method="post" action="RepairCustomerUpdateServlet">
			<fieldset><table class="reptbl">
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="addressLine"value="<%=addressLine%>"><br></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="city"value="<%=city%>"><br></td>
			</tr>
			<tr>
				<td><lable >Phone</lable></td>
				<td><input type="number" name="phone"value="<%=phone%>"><br></td>
			</tr>
			...
			<input type="submit" class="button" value="Update customer" name = "repcusUpdate">
